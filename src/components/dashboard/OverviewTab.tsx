...
export const OverviewTab: React.FC<OverviewTabProps> = ({
  ...
  return (
    <div className="space-y-8 py-2">
      ...
      <section className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div className="space-y-1.5">
            ...
            <h1 className="text-3xl sm:text-5xl font-black text-[#EAE5D9] tracking-tight">
          ...
          <div className="flex items-center gap-2 self-start md:self-auto">
            {isLive ? (
              ...
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/20 text-xs font-bold text-amber-400">
        ...
        <div className="p-6 sm:p-8 bg-neutral-950 border border-neutral-900 rounded-3xl space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-2 border-b border-neutral-900 pb-4">
            <div>
              <span className="text-xs font-bold text-neutral-500 uppercase tracking-widest block">Current Website Status</span>
              <span className="text-lg sm:text-xl font-extrabold text-[#EAE5D9] mt-1 block">
            ...
            <div className="text-left sm:text-right">
              ...
              <span className="text-[11px] font-bold text-neutral-400 uppercase tracking-wider block">Website Completed</span>
            </div>
          </div>
          ...
          <div className="w-full bg-neutral-900 rounded-full h-3 overflow-hidden p-0.5 border border-neutral-800">
            <div
              className="bg-amber-500 h-full rounded-full transition-all duration-500 shadow-[0_0_12px_rgba(245,158,11,0.5)]"
      ...
      <section className="p-6 sm:p-8 bg-gradient-to-br from-neutral-900 via-neutral-950 to-black border-2 border-amber-500/30 rounded-3xl relative overflow-hidden shadow-2xl">
        ...
        <h2 className="text-2xl sm:text-3xl font-extrabold text-[#EAE5D9] tracking-tight">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          ...
          <button
            ...
            className="px-6 py-4 bg-amber-500 hover:bg-amber-400 text-black font-extrabold text-xs uppercase tracking-wider rounded-2xl flex items-center justify-center gap-2 transition-all cursor-pointer shadow-xl shadow-amber-500/20"
          >
          ...
          {project.websiteUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-5 py-4 bg-emerald-500 text-black font-black text-xs rounded-2xl transition-all flex items-center justify-center gap-2 shadow-lg"
            >
              <Globe size={15} />
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-6 bg-neutral-950 border border-neutral-900 rounded-3xl space-y-3">
          <span className="text-[11px] font-bold text-amber-400 uppercase tracking-widest block">
            Right Now
          </span>
          <h3 className="text-base font-bold text-[#EAE5D9]">What CodeFuser is working on</h3>
          ...
          <div className="pt-2 border-t border-neutral-900/80 space-y-1.5 text-xs text-neutral-400">
            <span className="text-[11px] font-bold text-neutral-500 uppercase block">Details you can send:</span>
            <div className="flex flex-wrap gap-2 pt-1">
              <span className="px-2.5 py-1 bg-black rounded-lg border border-neutral-800 text-neutral-300 text-[11px]">✓ Business Info</span>
              <span className="px-2.5 py-1 bg-black rounded-lg border border-neutral-800 text-neutral-300 text-[11px]">✓ Logo & Photos</span>
              <span className="px-2.5 py-1 bg-black rounded-lg border border-neutral-800 text-neutral-300 text-[11px]">✓ Website Address</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 bg-neutral-950 border border-neutral-900 rounded-3xl space-y-3">
          ...
          <h3 className="text-base font-bold text-[#EAE5D9]">You'll see it before we launch</h3>
          <p className="text-xs text-neutral-300 leading-relaxed">
          ...
          <div className="pt-2 border-t border-neutral-900/80 text-xs text-amber-300/90 flex items-center gap-2">
            ...
            >
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-3 py-2 bg-neutral-950 hover:bg-neutral-900 text-xs text-amber-400 font-bold rounded-xl border border-neutral-800 transition-all flex items-center gap-1"
                >
                  <span>Need Help</span>
                </a>
              </div>
      ...
      <section className="p-6 sm:p-8 bg-neutral-950 border border-neutral-900 rounded-3xl space-y-6">
        <div className="flex items-center justify-between border-b border-neutral-900 pb-4">
          <div>
            <h2 className="text-base font-bold text-[#EAE5D9]">Your Payment</h2>
